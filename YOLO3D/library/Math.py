...
def rotation_matrix(yaw, pitch=0, roll=0):
    ...
    # Return full rotation matrix combining all three rotations
    # Order matters: typically Rz * Ry * Rx for ZYX Euler angles
...
def calc_location(dimension, proj_matrix, box_2d, alpha, theta_ray):
    ...
    R = rotation_matrix(orient)  # This still uses only yaw for location calculation
