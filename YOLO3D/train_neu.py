...
python train_neu.py     --epochs 60     --batch_size 128     --num_workers 3     --save_epoch 10     --train_path ./data/daten     --model_path ./weights     --select_model resnet18     --api_key KfPzkJBufCei2Nko40NoOTYNy --bin_count 8
"""
...
def train(
    ...
    dataset = Dataset(train_path, bins= bin_count)  #!!!!!!!!!!! neu zum fix der anzahl der Bins
